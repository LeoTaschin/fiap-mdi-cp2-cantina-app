...
![Cardápio FIAP](assets/images/Prints/screenshot-home.png)
...
### Tela de pedidos
![Pedidos da Cantina](assets/images/Prints/screenshot-orders.png)
...
### Tela de perfil
![Perfil do usuário](assets/images/Prints/screenshot-profile.png)
...
### Tela de login
![Login de aluno](assets/images/Prints/screenshot-login.png)

A tela de login permite que o aluno faça autenticação com e-mail e senha, mostrando validação de campos em tempo real.

### Tela de cadastro
![Cadastro de aluno](assets/images/Prints/screenshot-register.png)
